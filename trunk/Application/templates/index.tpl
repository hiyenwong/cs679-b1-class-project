...
<div id="header_wrap">
            <div id="header"><!-- begin header -->
                ...
                <div id="header_lower">	
                  ...
                  <div id="header_sub_port">
                    ...
                    <a href="projects.html"><img width="50" height="50" class="go_button" alt="Go To Project" src="images/go-button.jpg"></a> </div>
                  </div><!-- header sub port -->
                  </div><!--end header sub-->
			...
			<div id="sub_boxes"><!-- start sub boxes  --> 
                ...
                <div class="sub_box">
            		<div class="sub_box_text">
              			<img width="40" height="40" class="sub_box_image" style="vertical-align:middle" alt="briefcase" src="images/speed.png"><h2>Speed</h2>
           			  <p>List here the benefits of feature1. </p>
           			  <p><a href="#">Read more <img width="20" height="20" style="vertical-align:top" alt="" src="images/arrow_right.png"></a></p>
           		  </div>
           	  </div>
                ...
                <div class="sub_box">
            		<div class="sub_box_text">
              			<img width="40" height="40" class="sub_box_image" style="vertical-align:middle" alt="display" src="images/shield.png"><h2>Information Safety</h2>
                ...
                <div class="sub_box_right">
            		<div class="sub_box_text">
              			<img width="40" height="40" class="sub_box_image" style="vertical-align:middle" alt="rolodex" src="images/danger.png"><h2>Growth</h2>
    ...
    <p><i> -- Tom Smith</i></p>
                ...
                <div id="main_content_right">
                    <h2 class="sub_box_text"><img width="27" height="24" class="sub_box_image" style="vertical-align:middle" alt="resources" src="images/resources.jpg">Resources and helpful links</h2>
